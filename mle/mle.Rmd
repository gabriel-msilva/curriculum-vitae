...
projects <- tribble(
  ...
  "melloc", 2022, glue::glue("Personal blog about (Data) Science (website at \\url{gabriel-msilva.github.io})", .open = "<", .close = ">"), NA_character_,
...
tribble(
  ...
  "Software development", "source control (Git), CI/CD (GoCD, Jenkins), unit test, Python packages (PIP/Conda), documentation websites",
