...
* Experience in **building and deploying** Machine Learning tools, models and data visualizations.
* Passionate about **teaching** and highly value **efficient communication and organization** between teams.
...
tribble(
  ~ skill, ~ contents,
  "Programming languages", "Python, R, Scala, Bash, SQL, Spark",
  "Software development", "source control (Git), CI/CD (GitHub Actions, GoCD, Jenkins), unit tests, Python packaging (pip/Conda/uv), documentation websites",
