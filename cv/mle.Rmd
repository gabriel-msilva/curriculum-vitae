...
www: "gabriel-msilva.github.io/melloc"
...
Engineer focused on building Machine Learning tooling and production workflows enabling quick insights, scalable model development and deployment.
...
projects <- tribble(
  ...
  "streamlit-arborist", 2025, "Open-source Streamlit component for visualizing interactive tree views.", NA_character_,
  "melloc", 2022, "My Technical blog about Data Science and software development.", NA_character_,
...
write_abbreviation <- function(.abbrv) {
  if_else(!is.na(.abbrv), glue::glue("({.abbrv})"), "")
}
...
```{r skills}
tribble(
  ~ skill, ~ contents, ~ description,
  "Software development",
  "Python, R, Scala, Bash, SQL, Spark",
  c(
    "API design, internal libraries, environment & packaging (pip/conda/uv/renv), versioning, semantic releases",
    "Pytest (fixtures, parametrization, property-based testing), CI/CD (GitHub Actions, GoCD, Jenkins)",
    "Documentation (Sphinx, MkDocs), template repositories, CLI tooling"
  ),

  "Data Science & Machine Learning", 
  "pandas, NumPy, scikit-learn, XGBoost, LightGBM, statsmodels, SciPy, FastAPI", 
  c(
    "EDA, preprocessing, feature engineering",
    "Model evaluation, monitoring, real-time and batch workflows",
    "Data visualization (Matplotlib, Plotly, ggplot2, plotnine, seaborn), dashboarding (shiny, streamlit)"
  ),

  "Cloud computing",
  "AWS, Docker, Kubernetes",
  c("Real-time model integration, workflow automation, containerization, orchestration"),

  "Communication & Teaching",
  NA_character_,
  c(
    "Stakeholder communication, cross-team collaboration, agile methodologies",
    "Technical presentations, training sessions, mentoring",
    "Documentation-writing, architecture explanations, tutorial development"
  )
) %>% 
  detailed_entries(what = contents, with = skill, why = description)
```
